...
function count(elem) {
    ...
    //CountDown
    var dateOfBeginning = "Jan 20, 2015", //type your date of the Beginnig
...
function smoothScrollInit() {
    ...
    // Smooth scroll
    $elem.bind('click.smoothscroll', function(e) {
        e.preventDefault();
...
//Start Nivo slider
function initBlueberrySlider(container) {
